...
if __name__ == "__main__":
    ...
    # python scripts_data_process/build_selectedStats_from1980.py
    # python scripts_data_process/build_selectedStats_from1980.py --start 1980 --end 2020
    ...
    # Setup argparse
    parser = argparse.ArgumentParser(description="Build and process the selectedStats_from1980 pipeline.")
